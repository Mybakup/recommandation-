...
import { Plane, Stethoscope, ArrowRight, Globe, Shield, MessageSquare, Clock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#EDF5FF] via-white to-[#FFE8E8] relative overflow-hidden">
      ...
      <main className="relative max-w-4xl mx-auto px-4 py-8 min-h-screen flex flex-col">
        ...
        <div className="text-center mb-8 flex-shrink-0">
          <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-[#9333EA] to-[#ff3c00] bg-clip-text text-transparent animate-gradient">
            Mybakup
          </h1>
        ...
        {/* Swipe indicator */}
        {showSwipeHint && (
          <div className="text-center text-gray-500 text-xs mb-4 animate-swipe-hint">
