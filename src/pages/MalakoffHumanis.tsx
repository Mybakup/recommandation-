...
interface MalakoffHumanisProps {
  onClose?: () => void;
}

export default function MalakoffHumanis({ onClose }: MalakoffHumanisProps) {
    ...
    <div className="bg-white rounded-2xl overflow-hidden shadow-xl max-h-[90vh] overflow-y-auto">
      ...
      <div className="sticky top-0 z-50 bg-white border-b border-gray-200">
        <div className="max-w-3xl mx-auto px-4">
          <div className="py-4 flex items-center justify-between">
            <img 
              src="https://i.imgur.com/malakoff-logo.png"
      ...
      <main className="max-w-3xl mx-auto px-4 py-6 space-y-6">
            ...
            <div className="flex-1 space-y-6">
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-2xl font-bold text-mybakup-blue">
                  Vos services Malakoff Humanis
                </h2>
              </div>
              <p className="text-gray-600">
                Accédez à tous vos avantages et services en tant qu'assuré Malakoff Humanis
              </p>
              <button
                onClick={() => window.open('https://www.malakoffhumanis.com', '_blank')}
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a href="tel:3932" className="text-gray-600 hover:underline">
                  3932
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a href="mailto:contact@malakoffhumanis.com" className="text-gray-600 hover:underline">
                  contact@malakoffhumanis.com
                </a>
              </div>
            </div>
        ...
        <section className="bg-white rounded-xl p-6 space-y-4 border border-gray-200">
          ...
          <button
            onClick={() => window.open('https://www.malakoffhumanis.com/espace-client', '_blank')}
